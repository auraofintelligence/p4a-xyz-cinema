(() => {
  ...
  const moduleConfigs = {
    ...
    "sensorium-place-pack": {
      ...
      capabilityScope: "fractal",
      visibility: "permissioned",
      sourceRepo: "Sovereign Space Builder source notes; Web3 Sensorium; Moreton Bay digital twin patterns",
      sourceBuilder: "pages/p4a-builder.html?tool=sensorium-place-pack",
      purpleTranslation: "Purple-ified from sensorium, digital twin and living-boundary source notes for place-based civic memory.",
