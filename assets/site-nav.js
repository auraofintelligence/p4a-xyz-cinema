...
(() => {
  ...
  const SECTIONS = [
    ...
    },
    {
      ...
      num: '02',
      label: 'The spark',
      blurb: 'Twinkle: short, spicy clips for the obvious gripes. The way in, not the whole system.',
      links: [
        { href: 'pages/twinkle.html', title: 'Twinkle series', note: 'All the clips and where each one leads.' },
